...
void main() {
  ...
  void setupMockMethodCallHandlerWithMockFunctions(Function mockOnListen, Function mockOnCancel) {
  ...
  test('listens stream of ymd.dev/audio_capture_event_channel channel', () async {
  ...
  test('cancels to listen stream ymd.dev/audio_capture_event_channel channel', () async {
    setupMockMethodCallHandlerWithMockFunctions(mock!.onListen, mock!.onCancel);
